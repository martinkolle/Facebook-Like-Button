...
<span style="color:grey; font-size:10px; <?php if($copyright == '0') echo "display:none;"; ?>"> 
		...
		<a href="http://martiinkolle.dk" title="Facebook Like Button for Joomla 1.5 and 1.6. Do you want a Joomla based website? Which includes Javascript and a great design?">Martiinkolle.dk</a>
</span>
<?php
endif;
?>
