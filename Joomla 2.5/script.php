...
<div style="width:100%" id="facebooklike"> 
	...
	<strong>Plugin:</strong> Vombie facebook Like (Open Graph Support) 	'.$this->CheckPlugin().'
	<br />
...
color: #00922D !important;" href="http://extensions.joomla.org/extensions/social-web/republish/16585" target="_blank">Vote at JED</a>
	...
	function CheckPlugin(){
		...
		if (!$enabled) : 
			echo 'Not Enabled: <span style="color:red;">Facebook Like (Open Graph support)</span> <br/>';
			echo 'Please enable to use Open Graph.';
		endif;
